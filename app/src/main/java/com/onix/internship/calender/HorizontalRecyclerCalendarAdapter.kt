package com.onix.internship.calender
...
class HorizontalRecyclerCalendarAdapter(
    ...
    class MonthCalendarViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val textViewDay: TextView = itemView.findViewById(R.id.textCalendarItemHorizontalDay)
        val textViewDate: TextView = itemView.findViewById(R.id.textCalendarItemHorizontalDate)
    }
}