...
class DialogString  {
    val dialogsSceneLectureHall= listOf(
 ...
 val dialogSceneUni : List<String> = listOf(
     ...
     " Silvia:Привет! Как тебе урок?",
     "Me:Хорошо…",
      "Me: Я не мог собраться и признать, что весь он сначала влетел в одно ухо, а затем вылетел в другом.",
     "Me: m Ты сейчас идёшь домой? Хочешь пройтись вместе со мной?",
     "Silvia: Конечно!",
     "Далее")
    val dialogSceneMeadow : List<String> = listOf(
