...
private fun validatePassword(): Boolean {
    when {
        ...
        !isStringContainNumber(binding.password.text.toString()) -> {
            binding.passwordTextInputLayout.error = getString(R.string.required_digit)
            binding.password.requestFocus()
            return false
        }
        !isStringLowerAndUpperCase(binding.password.text.toString()) -> {
            binding.passwordTextInputLayout.error = getString(R.string.lower_letters)
            binding.password.requestFocus()
            return false
        }
        !isStringContainSpecialCharacter(binding.password.text.toString()) -> {
